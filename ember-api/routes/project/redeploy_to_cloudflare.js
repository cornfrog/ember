...
const redeploy_to_cloudflare = Router();

redeploy_to_cloudflare.post("/", async (request, response) => {
    ...
    try {
        ...
        const command = `${scripts_directory}/reupload ${project.name}`;
...
export default redeploy_to_cloudflare;